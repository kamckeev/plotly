    ...
    /// Guage Chart ///
      ...
      var data = [{ type: 'scatter',
        ...
        marker: {colors:['rgba(0, 128, 0, 1)', 'rgba(0, 128, 0, .9)',
                              ...
                              'rgba(0, 128, 0, .2)',
                              'rgba(255, 255, 255, 0)']},
        labels: ['Obsessively Squeaky clean...', 'Extra Squeaky Clean!', 'Showers Daily', 
        'Showers on the Regular', 'Showers Regularly','Ocassional Washing', 'Low','A bit Dusty', 'Full of Lint',''],
        hoverinfo: 'label',
        hole: .5,
        type: 'pie',
        showlegend: false
